...
class Enemy(pygame.sprite.Sprite):
    ...
    def move(self):
        ...
        # если враг ушел вниз → +1 к счету и новый спавн
...
# 🪙 Coin class (с масштабированием)
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()

        # Загружаем оригинальное изображение монеты
    ...
    def move(self):
        ...
        # если монета ушла вниз → создать новую
        if self.rect.top > SCREEN_HEIGHT:
            self.respawn()

    def respawn(self):
        # 🎲 новый случайный размер
        self.size = random.randint(20, 50)
...
while True:
    ...
    # 🪙 Проверка подбора монеты
    collected = pygame.sprite.spritecollide(P1, coins, False)
    for coin in collected:
        COINS += 1  # увеличиваем счетчик
        coin.respawn()  # новая монета
